...
class Injection extends Object {
    ...
    getPaths: ({ active_document }: { active_document: vscode.TextDocument; }) => import("/home/on/Projects/vscode-phoenix-webhelpers/runexecFlamekit/code/src/interface").IPaths;
    ...
    getWorkingPaths: ({ wsf, active_document }: { wsf: readonly vscode.WorkspaceFolder[]; active_document: vscode.TextDocument; }) => import("/home/on/Projects/vscode-phoenix-webhelpers/runexecFlamekit/code/src/interface").IWorkingPaths;
